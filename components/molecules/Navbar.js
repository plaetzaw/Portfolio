    ...
    <div className='flex flex-col p-4 bg-[#5F3C92] w-100'>
      ...
      <div className={`${props.isOpen ? 'h-screen' : 'auto'} `}>
        <ul className={`flex ${props.isOpen ? 'flex-col' : 'hidden'} items-center gap-1 text-center h-screen md:flex flex-row justify-evenly md:h-auto`}>
          <li className='text-4xl h-1/4 text-[#F2EFEF] md:text-xl py-2' onClick={() => closeMobileView(props.refSet.about)}>About</li>
          <li className='text-4xl h-1/4 text-[#F2EFEF] md:text-xl py-2' onClick={() => closeMobileView(props.refSet.projects)}>Projects</li>
          <li className='text-4xl h-1/4 text-[#F2EFEF] md:text-xl py-2' onClick={() => closeMobileView(props.refSet.technologies)}>Technologies</li>
          <li className='text-4xl h-1/4 text-[#F2EFEF] md:text-xl py-2' onClick={() => closeMobileView(props.refSet.contact)}>Contact</li>
